...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.daks') }}" class="btn btn-outline-primary">
            ...
            <!-- Form Card -->
            <form action="{{ route('admin.daks.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">
                                                पत्र कहाँ से प्राप्त हुआ / Letter Received From
                                                <sup class="text-danger">*</sup>
                                            </label>
                            ...
                            <div class="card-footer text-start">
                                ...
                                <a href="{{ route('admin.daks') }}" class="btn btn-secondary">
                                    वापस जाएँ / Back
                                </a>
                            </div>
                        </div>
